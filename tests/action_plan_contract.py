...
class ActionPlanContractTests(unittest.TestCase):
    ...
    def test_batch_gate_binds_every_exact_head(self) -> None:
        test_batch_gate_binds_every_exact_head()

    def test_batch_drift_rejects_only_the_changed_item(self) -> None:
        test_batch_drift_rejects_only_the_changed_item()

    def test_batch_execution_fails_on_expiration(self) -> None:
        test_batch_execution_fails_on_expiration()

    def test_batch_mutation_item_forbids_unsafe_arguments(self) -> None:
        test_batch_mutation_item_forbids_unsafe_arguments()

    def test_batch_mutation_item_requires_allowed_patterns(self) -> None:
        test_batch_mutation_item_requires_allowed_patterns()

    def test_batch_confirmation_rejects_mismatched_items(self) -> None:
        test_batch_confirmation_rejects_mismatched_items()

    def test_batch_execution_requires_plan_issued_capability(self) -> None:
        test_batch_execution_requires_plan_issued_capability()

    def test_batch_cross_repository_pr_number_collision(self) -> None:
