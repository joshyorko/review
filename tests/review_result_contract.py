...
class ReviewResultContractTests(unittest.TestCase):
    ...
    def test_current_engine_adapter_is_deterministic_and_keeps_raw_evidence(self):
        output = """check security: 1 finding(s)\nHIGH x.py:7 unsafe path\ncheck tests: passed\n"""
        ...
        self.assertEqual(result.findings[0]["file"], "x.py")
