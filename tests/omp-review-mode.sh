...
if ((node_major < 24)); then
  if command -v bun >/dev/null 2>&1; then
    bun test tests/omp-review-mode.test.ts tests/blueberry_mode.test.ts tests/pr_reader.test.ts tests/personal_policy.test.ts tests/luna_factory.test.ts tests/luna_factory_dogfood_contract.test.ts
...
node --test --disable-warning=MODULE_TYPELESS_PACKAGE_JSON tests/omp-review-mode.test.ts tests/blueberry_mode.test.ts tests/pr_reader.test.ts tests/personal_policy.test.ts tests/luna_factory.test.ts tests/luna_factory_dogfood_contract.test.ts
python3 tests/personal_brew_oci_contract.py
bash tests/launcher-contract.sh
