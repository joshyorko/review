...
# Use cached container image if present, or fallback to OCI source
CONTAINER_IMAGE="${BREW_TEST_CONTAINER:-docker://docker.io/homebrew/ubuntu22.04:latest}"
if [[ -f "/home/jorge/.apptainer/cache/oci-tmp/d8a522eebfc19d078563b3d9252b08cbd22a9b9b1f17c0cba69cea58ac3fdd6c" ]]; then
  CONTAINER_IMAGE="/home/jorge/.apptainer/cache/oci-tmp/d8a522eebfc19d078563b3d9252b08cbd22a9b9b1f17c0cba69cea58ac3fdd6c"
fi
