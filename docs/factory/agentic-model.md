...
| **Dashboard Activity** | The high-priority, bounded display of active parent reviews, check subagents, landing agents, queued work, and freshness. | It reports live or retained evidence; it never assigns Hive work. |
